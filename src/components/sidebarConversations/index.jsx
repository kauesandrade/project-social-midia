...
const sidebarConversations = () => {
    ...
    const [conversationsData, setConversationsData] = useState([
        ...
        {srcProfileImg: "src/assets/imagens/profile.jpg", profileName: 'Kaue Andrade', status: 'Send 6h ago', selection: 'noSelectionConversation'},
        {srcProfileImg: "src/assets/imagens/profile.jpg", profileName: 'Kaue Andrade', status: 'Online', selection: 'noSelectionConversation'}
    ])
